#pragma checksum "/home/shunjid/Documents/Project/Version2/NoResume/Views/Shared/_initHome.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c923901b299f8cd3dcc42d7b211fb38cb3b2194d"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c923901b299f8cd3dcc42d7b211fb38cb3b2194d", @"/Views/Shared/_initHome.cshtml")]
    ...
    public class Views_Shared__initHome : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
            BeginContext(0, 15979, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("environment", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c923901b299f8cd3dcc42d7b211fb38cb3b2194d4251", async() => {
                BeginContext(35, 5, true);
                WriteLiteral("\n    ");
                EndContext();
                BeginContext(40, 72, false);
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c923901b299f8cd3dcc42d7b211fb38cb3b2194d4634", async() => {
                }
                );
...
#line 2 "/home/shunjid/Documents/Project/Version2/NoResume/Views/Shared/_initHome.cshtml"
         ...
         for(var i = data.result.length - 1; i >= 0 ; i--) {
           ...
           */
           ...
           if(cf_problems_attempt_solved[problemId] === undefined){
               cf_probl");
                WriteLiteral(@"ems_attempt_solved[problemId] = {
                 attempts : 1,
                 solved : 0  
               };
           } else{
           ...
           */
           if(cf_languages[submission.programmingLanguage] === undefined){
               cf_languages[submission.programmingLang");
                WriteLiteral(@"uage] = 1;
           } else{
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            EndContext();
            BeginContext(15979, 3, true);
            WriteLiteral("\n\n\n");
            EndContext();
            BeginContext(15982, 17555, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("environment", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c923901b299f8cd3dcc42d7b211fb38cb3b2194d24265", async() => {
                BeginContext(16017, 5, true);
                WriteLiteral("\n    ");
                EndContext();
                BeginContext(16022, 72, false);
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c923901b299f8cd3dcc42d7b211fb38cb3b2194d24655", async() => {
                }
                );
                __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
                __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
                ...
                __Microsoft_AspNetCore_Mvc_TagHelpers_ScriptTagHelper.Src = (string)__tagHelperAttribute_0.Value;
                __tagHelperExecutionContext.AddTagHelperAttribute(__tagHelperAttribute_0);
#line 388 "/home/shunjid/Documents/Project/Version2/NoResume/Views/Shared/_initHome.cshtml"
__Microsoft_AspNetCore_Mvc_TagHelpers_ScriptTagHelper.AppendVersion = true;
...
#line hidden
 ...
 ");
                        ...
                        $.post('', $('#formDevUname').serialize(), function (response) {
                            if(response === null || response === """" || response === ""null""){
                             ...
                             _initBioCardDev(response[0]);
                              ...
                              // CodeForces Resume Maker
                              if(Wo");
                WriteLiteral(@"rkingProfile.codeforcesUsername != null){
                                  cf_handle = WorkingProfile.codeforcesUsername;
                                  requestToCodeForces = $.get(cf_api_url + 'user.status', { handle : cf_handle }, function(data, status) {
                                    if(data.result.length < 1){
                ...
                WriteLiteral(@"s
                                        ...
                                        // Set Bar Chart : Tags
                                        var levelsDataArray = $.map(cf_attempt_level_quality,function(v){ return v; });
                                        CodeForcesCreateBarCharts(Object.keys(cf_attempt_level_quality), leve");
                WriteLiteral(@"lsDataArray, $('#levels_codeForces_bar'), 'Level of problems solved by '+cf_handle);
         ...
         function CodeForcesDataProcessor(data){
             ...
             for(var i = data.result.length - 1; i >= 0 ; i--) {
               ...
               **
     ");
                WriteLiteral(@"          ** cf_problems_attempt_solved[problemId] is checked firstly if it is defined or, not
               ** if cf_problems_attempt_solved[problemId] is not defined then attempt is set to 1
               ** and solved is set to 0
               **
               ** else it will be counting till the problem is solved
               ...
               */
               ...
               /*
               ** #Counting Solved : HOW_MANY_WAYS
               ** It means number of times a problem is s");
                WriteLiteral(@"olved according to VERDICT == OK
               ** 
               ** It will increment cf_problems_attempt_solved[problemID].solved
               */
               if(submission.verdict === 'OK'){
               ...
               if(submission.verdict === 'OK' && cf_problems_attempt_solved[problemId].solved === 1){
                ...
                WriteLiteral(@"@1 because
                   ...
                   **/
                   ...
                   if(cf_attempt_rating_quality[submission.problem.rating] === undefined){
            ");
                WriteLiteral(@"         cf_attempt_rating_quality[submission.problem.rating] = 1;  
                   } else{
                       cf_attempt_rating_quality[submission.problem.rating]++;
                   }
                   delete cf_attempt_rating_quality.undefined;
   ...
   ");
         ...
         function CodeForcesEffortSummary() {
            ...
            for(var submissions in cf_problems_attempt_solved){
                ...
                ");
                WriteLiteral(@"// For Each Submission : numberOfTimesTried increments to 1 
                numberOfProblemsTried += 1;
                ...
                if(cf_problems_attempt_solved[submissions].solved > maximumNumberAProblemAccepted){
                    maximumNumberAProblemAccepted = cf_problems_attempt_solved[submissions].solved;
                ");
                WriteLiteral(@"    maximumAcceptedProblemInfo = submissions;
                }
            ...
            $('#DevMaxAttemptedProblems').text(maximumAttemptsBeforeSolvingAProblem + ""("" + maximumProblemBeenAttempted + "")"");
   ");
                WriteLiteral(@"         $('#DevMaxAcceptedProblems').text(maximumNumberAProblemAccepted + ""("" + maximumAcceptedProblemInfo + "")"");
            $('#DevAcceptedAtFirstTry').text(OneSubmissionTry);
          }
