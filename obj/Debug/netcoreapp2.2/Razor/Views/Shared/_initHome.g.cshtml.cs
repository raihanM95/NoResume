#pragma checksum "/home/shunjid/Documents/WebApps/DotnetCore/NoResume/Views/Shared/_initHome.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "19b0352ead98e836fb85bf82988993584d46fcf9"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"19b0352ead98e836fb85bf82988993584d46fcf9", @"/Views/Shared/_initHome.cshtml")]
    ...
    public class Views_Shared__initHome : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
            BeginContext(0, 16504, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("environment", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "19b0352ead98e836fb85bf82988993584d46fcf93955", async() => {
                BeginContext(35, 5, true);
                WriteLiteral("\n    ");
                EndContext();
                BeginContext(40, 72, false);
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "19b0352ead98e836fb85bf82988993584d46fcf94338", async() => {
                }
                );
...
#line hidden
                ...
                EndContext();
                BeginContext(112, 9186, true);
                WriteLiteral(@"
    
    <script type=""text/javascript"">
    var colorArray=[""#4527A0"", ""#00695C"", ""#2E7D32"", ""#558B2F"", ""#F9A825"", ""#FF7043"", ""#8D6E63"", ""#424242"", ""#455A64"", ""#283593"", ""#1565C0"", ""#0277BD"", ""#00838F"",  
    ""#ec407a"",""#4a148c"",""#f4511e"",""#00695c"",""#ffcc80"",""#424242"",""#6d4c41"",""#00bfa5"",""#0288d1"",""#ef5350"",
    ""#66bb6a"",""#ffe082"", ""#f44336"",""#E91E63"",""#9C27B0"",""#673AB7"",""#2196F3"",""#009688"",""#8BC34A"",
    ""#CDDC39"",""#FFC107"",""#FF9800"",""#FF5722"",""#795548"",""#607D8B"",""#E65100"",""#827717"",""#004D40"",
    ""#1A237E"",""#6200EA"",""#3F51B5"",""#F50057"",""#304FFE"",""#b71c1c""];
    ...
    var cf_attempt_rating_quality = {};
        ...
        $(document).ready(function(){
            ...
            ** Send it to /Home/Index(IFormCollection formFields)
            ...
            $(""#formDevUname"").submit(function(e){
                ...
                $(""#resume"").fadeOut();
                // Show p");
                WriteLiteral(@"reloader on form post
                $(""#intLoader"").show();
                        ...
                        if(response === null || response === """" || response === ""null""){
                         ...
                         _initBioCardDev(response[0]);
                          ...
                          if(WorkingProfile.codeforcesUsername != null){
                             ...
                             ");
                WriteLiteral(@"   if(data.result.length < 1){
         ...
         ");
                WriteLiteral(@"                           // Set Doughnut Chart : Tags
                                    ...
                                    CodeForcesCreateBarCharts(Object.ke");
                WriteLiteral(@"ys(cf_attempt_rating_quality), ratingsDataArray, $('#problem_rating_codeForces_bar'), 'Rating of problems solved by '+cf_handle);
     ...
     function CodeForcesDataProcessor(data){
         ...
         for(var i = data.result.length - 1; i >= 0 ; i--) {
           ...
           ** the goal is to count how many attempts was ");
                WriteLiteral(@"taken before solved 
           */
           ...
           * 
           *");
                WriteLiteral(@"* Counting number of each type of languages
     ...
     function CodeForcesEffortSummary() {
        ...
        /*console.log(cf_problems_attempt_solve");
                WriteLiteral(@"d);
    ...
    function _initBioCardDev(response) {
      ...
      _DevUser");
                WriteLiteral(@"name.text(toTitleCase($('#developerUsername').val())+""(""+_DevCurrentCity+"")"");
